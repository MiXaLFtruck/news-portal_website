...
urlpatterns = [
    ...
    path('category/<str:name>/', cache_page(60*5)(InCategoryList.as_view()), name='incategory_list'),
    path('category/<str:name>/subscribe/', subscribe_for_category, name='subscribe'),
